...
#NUM_cHANNELS=input_tensor.shape[-1] , so that can be saved
def LeNet5(input_tensor, train, regularizer,  NUM_CHANNELS, NUM_LABELS):
    ...
    with tf.variable_scope('layer5-fc1'):
        ...
        keep_prob=tf.cond(train, lambda: 0.5, lambda: 1.0)
