...
def AlexNet_run():
    ...
    with tf.Session(config=config) as sess:
        ...
        Path(os.path.join(save_dir, 'accuracy_loss', 'train_acc')).mkdir(parents=True, exist_ok=True)
        Path(os.path.join(save_dir, 'accuracy_loss', 'valid_loss')).mkdir(parents=True, exist_ok=True)
        Path(os.path.join(save_dir, 'accuracy_loss', 'valid_acc')).mkdir(parents=True, exist_ok=True)
